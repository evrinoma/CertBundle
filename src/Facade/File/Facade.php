...
namespace Evrinoma\CertBundle\Facade\File;

use Evrinoma\CertBundle\Manager\File\CommandManagerInterface;
use Evrinoma\CertBundle\Manager\File\QueryManagerInterface;
use Evrinoma\CertBundle\PreValidator\File\DtoPreValidatorInterface;
