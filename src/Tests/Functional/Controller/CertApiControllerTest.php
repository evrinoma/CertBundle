 ...
 * @group functional
 */
final class CertApiControllerTest extends AbstractFunctionalTest
{
    protected string $actionServiceName = 'evrinoma.cert.test.functional.action.cert';
    ...
    {
        return [FixtureInterface::CERT_FIXTURES];
    }
}
